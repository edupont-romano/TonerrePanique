...
\item 3x \marqueursObstacles, avec les différents obstacles que vous pouvez rencontrer (\includegraphics[scale=0.15]{icones/icones_arbre},\includegraphics[scale=0.15]{icones/icones_rocher}, \includegraphics[scale=0.15]{icones/icones_tronc})
...
\item 66x cartes recto-verso \includegraphics[scale=0.15]{regle/cartes}. D'un côté, des randonneurs, de l'autres de bonus.
