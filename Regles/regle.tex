...
\newcommand{\faceValeur}{face valeur \includegraphics[scale=0.5]{obstacles/faceValeur/faceValeur_13}}
\newcommand{\faceObstacle}{face obstacle \includegraphics[scale=0.5]{obstacles/faceObstacle/faceObstacle_15}}
...
\newcommand{\jetonMeteo}{jeton meteo \includegraphics[scale=0.2]{jetonsMeteo/verso}}
\newcommand{\jetonsMeteo}{jetons meteo \includegraphics[scale=0.2]{jetonsMeteo/verso}}
...
\title{\includegraphics[scale=0.2]{titre/titre}}
\edr
\begin{document}
	\dateVersion{v1.0.0}
	\maketitle
