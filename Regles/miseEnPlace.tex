...
\begin{figure}[h]%
    \subfloat[\centering Le plateau central]{{\includegraphics[scale=0.35]{regle/plateau} }}%
    \qquad
    \subfloat[\centering Le plateau de chaque joueur]{\includegraphics[scale=0.4]{regle/plateauJoueur}}%
